...
public class TileEntityEnergyCube extends TileEntityElectricBlock implements IComputerIntegration, IRedstoneControl, ISideConfiguration, ISecurityTile, ITierUpgradeable,
    ...
    private static final String[] methods = new String[]{"getEnergy", "getOutput", "getMaxEnergy", "getEnergyNeeded", "getInputEnergy", "getOutputEnergy", "isCharging"};
    /**
    ...
    public double previousEnergyStored = getEnergy();
    ...
    public Object[] invoke(int method, Object[] arguments) throws NoSuchMethodException {
        switch (method) {
            ...
            case 5:
                return new Object[]{0};
            case 6:
                return new Object[]{previousEnergyStored < getEnergy()};
            default:
    ...
    public void setEnergy(double energy) {
        previousEnergyStored = getEnergy();
